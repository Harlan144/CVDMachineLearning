...
#Change these values according to the images you want to test, the model, and the desired output directory.
test_images_dir = "TestImages/"
model_weight_path = "SavedModelOutput/SavesModel7/first_save.h5"
output_dir = "SavesModel7/"
...
#
model.load_weights(model_weight_path) #Call the save from Model 7.
...
plot_cm(test_labels, predictions, p=0.5, savePath=os.path.join(output_dir,"PlotConfusionMatrix")) #plot the confusion matrix.
